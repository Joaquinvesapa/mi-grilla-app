...
create table public.attendance (
  ...
  artist_id   text not null,             -- composite ID del artista (ej: "Viernes-Tyler,-The-Creator")
...
comment on column public.attendance.artist_id   is 'ID compuesto del artista generado por parseSchedule (dia-nombre, sin escenario)';
